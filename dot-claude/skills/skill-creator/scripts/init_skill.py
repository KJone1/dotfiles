...
SKILL_TEMPLATE = """---
name: {skill_name}
description: [TODO: Guide for [brief summary of what the skill does]. This skill should be used when users want to [specific actions/goals] that [benefit/outcome].]
---
